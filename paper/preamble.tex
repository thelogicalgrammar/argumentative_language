...
\RequirePackage{soul}
\RequirePackage{relsize} % command \relsize{+/-x} for relative font size
...
\newcommand{\mf}[1]{\textcolor{shimmer-bright}{[MF: #1]}}
...
\newcommand{\greensquare}{\raisebox{1.5pt}{\textcolor{Green}{\Large{\ensuremath{▪}}}}}
...
\newcommand{\greensquareSS}{\raisebox{1.5pt}{\textcolor{Green}{\footnotesize{\ensuremath{▪}}}}}
